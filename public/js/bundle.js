...
exports.updateUser = exports.getSearchedUsers = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("/api/v1/users?".concat(property, "=").concat(val)).then(function (response) {
              users = res.data;
            });
          ...
          case 3:
            ...
            if (users) {
              ...
              (0, _alerts.showAlert)('success', 'Data fetched');
            }
...
var manageUserForm = document.querySelector('.form--manageUsers');
var updateUserForm = document.querySelector('.form--updateUser'); // DELEGATION //
///////////////////////////////////////////////////////////////////////
...
if (manageUserForm) manageUserForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var el = document.getElementById('searchCriteria');
  var property = el.options[el.selectedIndex].value;
  console.log(property);
  var val = document.getElementById('searchValue').value;
  console.log(val);
  (0, _admin.getSearchedUsers)(property, val);
});
if (updateUserForm) updateUserForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    var id, photo, active, form;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "53754" + '/');
