    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51LfRoGSBv3gkrL92i8SQzWevZQ8Rgloq5wOUSnGnoNW3coUkbdli4Apy5PMshbKJ3MCX5NzcS7ue6s9ZfS29jYeK00CyKMhNys'); // 1) Get checkout session from endpoint/API
          ...
          case 4:
            ...
            console.log(session); // 2) Create the checkout form + charge credit card
