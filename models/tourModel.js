...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      mimlength: [10, 'A tour name must have minimum 10 characters']
    ...
    ratingsAverage: {
      type: Number,
      default: 4.5,
      min: [1, 'Rating must be not be less than 1.0'],
      max: [5, 'Rating must be not be greater than 5.0'],
    ...
    priceDiscount: {
      ...
      validate: {
        ...
        message: 'Discount ({VALUE}) should not be greater than price'
      }
    },
    summary: {
      type: String,
